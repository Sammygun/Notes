...
iTechArt Group в связи с расширением приглашает в свою команду Junior Python Developer.

Компания iTechArt одна из самых быстро растущих компаний в сегменте разработки инженерных решений для ведущих технологических, финансовых, страховых и фармацевтических компаний.

Требования:

Знакомство с Python, Django
Понимание основных концепций реляционных БД
Общее представление о разработке UI
Понимание принципов ООП
Английский язык на уровне Pre-Intermediate и выше
https://jobs.tut.by/vacancy/29777666?query=django


Попробуй после уроков MOSH django blog Написать или на Flask Тоже написать
